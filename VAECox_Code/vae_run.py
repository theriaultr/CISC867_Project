...
# os.system('python vae_main.py -mt vae -ol mrna@ -hn 4096 -lr 0.1 -dr 0.1 -wd 1e-5 -dv cuda -cd 0 -sn vae_pretrained -fc None -mx 2 -af Tanh -mo SGD -bs 0 -vd LIHC_VAE -sm') #changed to SGD from Adam

#run with multiple datasets - currently set to run with test data
os.system('python vae_main.py -mt vae -ol mrna@ -hn 4096 -lr 0.1 -dr 0.1 -wd 1e-5 -dv cuda -cd 0 -sn vae_pretrained -fc None -mx 500 -af Tanh -mo SGD -bs 0 -vd VAE -sm')
